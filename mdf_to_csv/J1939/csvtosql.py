...
parser.add_argument('--database', default="JdbcDatabase")
args = parser.parse_args()

file_path = os.getcwd()
file_name = "scaled.ChannelGroup_1_CCVS1_0xFEF1.csv"
...
timestamps = list(csv_data.timestamps)
Speed = list(csv_data.WheelBasedVehicleSpeed)
...
for time,Engine in zip(timestamps,Speed):
    query = "INSERT INTO jdbcEtable VALUES (%s, %s);" #table_name
...
fig = px.line(csv_data, x = timestamps, y = Speed, title='JdbcDatabase_WheelBasedVehicleSpeed')
# fig.show()
